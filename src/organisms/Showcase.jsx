...
const Showcase = () => {
	const caption1 =
		'thin rice noodle stir-fried with egg, preserved radish, bean sprouts, green onions, and sweet tamarind sauce. topped with fresh bean sprouts and crushed peanuts';
	const caption2 =
		'thai style fried rice with egg, tomatoes, carrots, green peas, yellow and green onions';
	const caption3 =
